        ...
        <div className="grid lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] lg:items-stretch">
          <div className="flex flex-col justify-center px-6 py-16 sm:px-10 sm:py-20 lg:px-16 lg:py-24 xl:px-24">
            <div className="flex max-w-xl flex-col items-start">
              ...
              <h1 className="mt-5 font-heading text-[44px] font-bold leading-[1.08] text-navy sm:text-[56px] lg:text-[52px] xl:text-[60px]">
                Staffing and Recruitment solutions across{" "}
                <span className="bg-gradient-to-r from-steel via-navy to-steel bg-clip-text text-transparent">
                  IT, healthcare, legal and more
                </span>
              </h1>
              <p className="mt-3 max-w-xl text-lg text-steel sm:text-xl">
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3.5">
                ...
                <ButtonLink
                  href="/get-hired"
                  variant="outline"
                  className="!border-navy !text-navy gap-2 transition-all hover:-translate-y-0.5 hover:!bg-navy hover:!text-white"
                >
                  <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" className="h-4 w-4 flex-shrink-0">
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 sm:px-10 sm:py-20 lg:px-16">
          <div className="grid items-start gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
            <div>
              ...
              <h2 className="mt-3.5 font-heading text-[32px] font-bold leading-tight text-navy sm:text-[36px]">
...
on paper.
          ...
          <div className="mt-11 grid grid-cols-2 gap-5 sm:grid-cols-3">
            <div className="group rounded-2xl border border-navy/[0.08] p-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-steel/40 hover:shadow-[0_20px_45px_-24px_rgba(1,35,64,0.3)]">
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-3">
            <div className="group rounded-2xl border border-navy/[0.08] p-7 transition-all duration-300 hover:-translate-y-1 hover:border-steel/40 hover:shadow-[0_20px_45px_-24px_rgba(1,35,64,0.3)]">
      ...
      <section id="industries" className="relative overflow-hidden border-t border-navy/[0.06] bg-white">
        <Image
          ...
          width={784}
          height={395}
          className="pointer-events-none absolute left-1/2 top-1/2 hidden h-[320px] w-auto -translate-x-1/2 -translate-y-1/2 select-none object-contain opacity-[0.14] md:block lg:h-[400px]"
        />
        <div className="relative mx-auto max-w-[1920px] px-6 py-20 sm:px-10 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-heading text-[30px] font-bold leading-tight text-navy sm:text-[34px]">
            ...
            {industries.map((industry) => {
              ...
              return (
                <a
                  ...
                  className="group relative rounded-2xl border border-navy/[0.08] bg-white p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-steel/40 hover:bg-steel/5 hover:shadow-[0_20px_45px_-20px_rgba(1,35,64,0.3)]"
                >
      ...
      <section className="border-t border-navy/[0.06] bg-white">
        <div className="relative mx-auto grid max-w-5xl items-center gap-12 px-6 py-14 sm:px-10 sm:py-16 lg:grid-cols-[0.85fr_1fr] lg:gap-16 lg:px-16 lg:py-20">
          ...
          <div>
            <h2 className="font-heading text-[38px] font-bold leading-tight text-navy sm:text-[46px]">
