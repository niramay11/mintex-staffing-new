...
export const industries: Industry[] = [
  {
    ...
    intro:
      "From full-stack developers to DevOps specialists, our IT staffing pool is screened for both technical depth and delivery track record.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "We handle license verification, credentialing, and compliance checks up front so your clinical teams can focus on patient care.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "We source engineers who've shipped real projects in your discipline, not just candidates who look good on paper.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "Our manufacturing talent pool spans shop floor to plant leadership, with a focus on safety record and process discipline.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "Every finance candidate we present has been screened for technical accounting skill and the judgment to communicate it to leadership.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "We match on organizational skill, discretion, and tooling fluency, not just years of generic office experience.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "We validate track record against real quota attainment data before a sales candidate ever reaches your interview loop.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "We screen for communication skill, product-learning speed, and composure under pressure, the traits that actually predict CX performance.",
    sectorInsight: {
  ...
  },
  {
    ...
    intro:
      "Our logistics talent pool is built for volume and speed, from a single warehouse supervisor to a multi-site staffing ramp.",
    sectorInsight: {
