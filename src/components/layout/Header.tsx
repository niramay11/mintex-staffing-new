    ...
    <header className="sticky top-4 z-50 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-[1700px] items-center justify-between gap-4 rounded-full border border-navy/[0.06] bg-white/85 py-2 pl-5 pr-2.5 shadow-[0_8px_30px_rgba(0,48,96,0.08)] backdrop-blur-md">
        <Link href="/" className="flex flex-shrink-0 items-center">
          <Image src={siteImages["global:header-logo-mark"]} alt="Mintex Staffing" width={72} height={36} priority className="h-9 w-auto lg:hidden" />
          <Image src={siteImages["global:header-logo"]} alt="Mintex Staffing" width={183} height={25} priority className="hidden h-6 w-auto lg:block" />
        </Link>
