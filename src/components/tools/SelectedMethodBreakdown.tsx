    ...
    <div className="relative mx-auto w-full max-w-md">
      ...
      <div className="relative overflow-hidden rounded-[24px] border border-navy/10 bg-white p-6 shadow-[0_30px_70px_-28px_rgba(0,48,96,0.3)]">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-steel">Via {methodLabel}</p>
        </div>

        <p className="mt-4 font-heading text-4xl font-bold text-navy">
          ${Math.round(result.total).toLocaleString("en-US")}
        </p>
        <p className="text-sm text-navy/90">estimated cost to fill this role this way</p>
